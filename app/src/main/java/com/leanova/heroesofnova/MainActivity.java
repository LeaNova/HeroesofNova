...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_grupos, R.id.nav_personajes, R.id.nav_razas, R.id.nav_clases, R.id.nav_mochilas, R.id.nav_armas, R.id.nav_armaduras, R.id.nav_items, R.id.nav_artefactos)
